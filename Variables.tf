...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "Regis-vpc", "created-by" = "regis", "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-asg-sg", "created-by" = "regis", "terraform" = "true", "project" = "tfdeploy" }
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-asg-iam-role", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-asg-instance", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "regis-asg-volume", "created-by" = "regis", "terraform" = "true", "project" = "tfdeploy" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "regis-asg", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-alb-sg", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-alb", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-rds-sg", "created-by" = "regis" , "terraform" = "true", "project" = "tfdeploy"}
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "regis-rds", "created-by" = "regis", "terraform" = "true", "project" = "tfdeploy"}
}
